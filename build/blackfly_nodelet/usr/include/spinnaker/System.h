...
#define FLIR_SPINNAKER_VERSION_MINOR 27
...
#define FLIR_SPINNAKER_VERSION_BUILD 48
    ...
    class SPINNAKER_API System : public ISystem
    {
      public:
        ...
        /**
         * Registers an event for the system
         *
         * @param evtToRegister The event to register for the system
         *
         */
        void RegisterEvent(Event& evtToRegister);

        /**
         * Unregisters an event for the system
         *
         * @param evtToUnregister The event to unregister from the system
         *
         */
