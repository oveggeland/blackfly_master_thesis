...
extern "C"
{
    ...
    */
    ...
    SPINNAKERC_API_DEPRECATED(
        "spinAVIRecorderOpenUncompressed is deprecated, use spinVideoOpenUncompressed instead.",
     ...
     */
    SPINNAKERC_API_DEPRECATED(
        "spinAVISetMaximumSize is deprecated, use spinVideoSetMaximumFileSize instead.",
